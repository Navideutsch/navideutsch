...
// // Mock 数据生成
// Mock.mock(/\/api\/reading\/article\/\d+/, 'get', (options) => {
//   const articleId = options.url.match(/\/api\/reading\/article\/(\d+)/)[1];
...
//     paragraphs.push({
//       paragraphId: i,
//       paragraphContent: Random.germanSentence(),
//       paragraphTranslation: Random.chineseTranslation(),
//     });
//   }
